        ...
        >
          ...
          >
            <div className={`backdrop-blur-sm rounded-2xl p-6 border transition-all duration-300 ${
              ...
              <p className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>AES-256 encryption with self-destructing messages</p>
            </div>
            ...
            <div className={`backdrop-blur-sm rounded-2xl p-6 border transition-all duration-300 ${
              ...
              <p className={isDarkMode ? 'text-gray-300' : 'text-gray-600'}>No registration required, complete privacy</p>
            </div>
          ...
          >
            <div>
              ...
              <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Messages</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-purple-400">🔒</div>
              <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Encrypted</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-green-400">⚡</div>
              <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Real-time</div>
            </div>
          </motion.div>
        </motion.div>
      </div>
